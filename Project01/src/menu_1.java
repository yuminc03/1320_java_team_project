...
public class menu_1 {
	...
	private void initialize() {
		...
		lblNewLabel.setBounds(0, -41, 805, 537);// lblNewLabel를 배치 할 위치
		...
		JButton getmoney = new JButton("getmoney");// JButton getmoney에 "getmoney"멘트 넣기
		getmoney.setBounds(640, 12, 144, 45);// getmoney를 배치 할 위치
		getmoney.setBorderPainted(false);// 맨 앞 위에꺼 이름이랑 동일하게 만들기 안그러면 오류남 //투명화
		getmoney.setContentAreaFilled(false);// getmoney의 내용영역 채우기 없음
		frame.getContentPane().add(getmoney);// (getmoney)이미지를 getContentPane()에 부착
		getmoney.addActionListener(new ActionListener() {
			// 만들어진 버튼 "새 창 띄우기"에 버튼이 눌러지면 발생하는 행동을 정의
			@Override
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				new getMoney(); // 클래스 newWindow를 새로 만들어낸다
			}
		});

		JButton outmoney = new JButton("outmoney");// JButton outmoney에 "outmoney"멘트 넣기
		outmoney.setBounds(640, 69, 144, 45);// outmoney를 배치 할 위치
		outmoney.setBorderPainted(false);// 맨 앞 위에꺼 이름이랑 동일하게 만들기 안그러면 오류남 //투명화
		outmoney.setContentAreaFilled(false);// outmoney의 내용영역 채우기 없음
		frame.getContentPane().add(outmoney);// (outmoney)이미지를 getContentPane()에 부착
		outmoney.addActionListener(new ActionListener() {
			// 만들어진 버튼 "새 창 띄우기"에 버튼이 눌러지면 발생하는 행동을 정의
			@Override
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				new outMoney(); // 클래스 newWindow를 새로 만들어낸다
			}
		});

		JButton goal = new JButton("goal");
		goal.setBounds(640, 139, 144, 45);// goal을 배치 할 위치
		...
		book.setBounds(640, 202, 144, 45);// book을 배치 할 위치
		...
		book.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				new Book(); // 클래스 newWindow를 새로 만들어낸다
			}
		});

		JButton calcu = new JButton("calcu");
		calcu.setBounds(640, 263, 144, 45);// calcu을 배치 할 위치
		...
		calender.setBounds(640, 332, 144, 45);// calender을 배치 할 위치
		...
		Memo.setBounds(640, 389, 144, 45);// memo을 배치 할 위치
